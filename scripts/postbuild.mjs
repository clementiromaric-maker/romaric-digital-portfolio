...
const required = [
  ...
  'Digital Production · Content Systems · Web & QA',
  'Digital produktion · Indholdssystemer · Web & QA',
  'Research to release',
  'Research til release',
  '163 interactions',
  '163 interaktioner',
  'Research and opportunity',
  'Research og mulighed',
  'Positioning and identity',
  'Positionering og identitet',
  'Launch system',
  'Launch-system',
  'Search, Google and local visibility',
  'Søgning, Google og lokal synlighed',
  'Sanitised direction map',
  'Sanitiseret retningskort',
  'SEO / Search Console / LocalBusiness JSON-LD',
  'Live content and route architecture',
  'QA, release and handover control',
  'Same decision logic across public routes',
  'Live indholds- og rutearkitektur',
  'QA-, release- og overdragelseskontrol',
