...
const roleFitLanes = [
  ...
  {
    label: '04',
    title: 'Digital delivery and QA support',
    text: 'GitHub-based workflow support, Jira issue follow-up, mobile checks, links, release notes, acceptance checks and practical handover.',
  },
];
        ...
        <section className="hero" id="top" aria-labelledby="hero-title">
          <div className="wrap hero__grid">
            <div>
              ...
              <p className="hero-role reveal" style={{ transitionDelay: '.1s' }}>Digital Production · Web Content · QA</p>
              ...
              <p className="sub reveal" style={{ transitionDelay: '.3s' }}>
                Website production, UX and content structure, CMS implementation support, responsive QA and multilingual delivery.
              </p>
            ...
            <aside className="spec reveal" style={{ transitionDelay: '.28s' }} aria-label="Portfolio quick facts">
              ...
              <dl>
                ...
                <div className="row">
                  ...
                  <dd>Live bilingual business site, real booking journey, responsive QA and owner handover</dd>
                </div>
              </dl>
            </aside>
          </div>
