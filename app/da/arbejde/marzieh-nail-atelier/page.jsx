...
const evidence = [
  ['Let levering', 'Holdt live-implementeringen praktisk at deploye, gennemgå og overdrage med lokale assets og tydelig kildekontrol.'],
  ['Sprogparitet', 'Kontrollerede engelsk og dansk service-, pris-, politik- og bookinglogik samlet for at reducere indholdsdrift.'],
  ['Release-QA', 'Verificerede navigation, responsiv adfærd, bookinghandlinger, links, metadata, lokale assets og indholdsparitet før release.'],
  ['Ejeroverdragelse', 'Versionsstyret kildepakke, deploy-noter, beslutninger om forretningskilder og tydelige næste skridt.'],
];
  ...
  return (
    <>
      ...
      <main className="case-page case-page--editorial">
        ...
        <section className="case-section case-section--screens"><div className="wrap"><div className="case-section__heading case-section__heading--wide"><p className="mono">04 / Interface</p><h2>Skærmene følger de spørgsmål, kunderne stiller før booking.</h2></div><div className="case-gallery-editorial case-gallery-editorial--real case-gallery-editorial--balanced"><figure className="case-shot case-shot--signature"><div className="case-shot__media"><img src="/assets/marzieh-composition-full-v687.webp" width="688" height="1487" loading="lazy" decoding="async" alt="Reelt mobilskærmbillede af The Atelier Composition-siden" /></div><figcaption><span>Signaturservice</span>Fuldt live mobiludsnit med servicenavn, forklaring og bookingvej synlig.</figcaption></figure><figure className="case-shot case-shot--service"><div className="case-shot__media"><img src="/assets/marzieh-service-path-proof-v687.webp" width="688" height="1020" loading="lazy" decoding="async" alt="Reelt mobilskærmbillede af Marzieh Nail Ateliers servicesektion: Choose the right service path first" /></div><figcaption><span>Servicevej</span>Reelt live-udsnit, der viser overgangen fra brandkontekst til servicevalg.</figcaption></figure><figure className="case-shot case-shot--guide"><div className="case-shot__media"><img src="/assets/marzieh-guide-proof-v687.webp" width="688" height="1430" loading="lazy" decoding="async" alt="Reelt mobilskærmbillede af Gel Nails vs Shellac-guiden" /></div><figcaption><span>Guideindhold</span>Reelt mobiludsnit, der viser hvordan praktisk bookingvejledning er struktureret og vedligeholdt.</figcaption></figure></div></div></section>

        <section className="case-section case-section--production"><div className="wrap"><div className="case-section__heading case-section__heading--wide"><p className="mono">05 / Tekniske beslutninger og overdragelse</p><h2>Hold løsningen praktisk efter lancering.</h2></div><div className="case-evidence-board">{evidence.map(([title, text], index) => <article key={title}><span>{String(index + 1).padStart(2, '0')}</span><h3>{title}</h3><p>{text}</p></article>)}</div><div className="production-disclosure"><h3>AI-assisteret produktion</h3><p>Claude, ChatGPT og andre AI-værktøjer understøttede research, udkast, kodehjælp og sammenligning. Jeg definerede brief og retning, udvalgte og reviderede output, testede implementeringen, traf de endelige beslutninger og havde ansvaret for deployment og overdragelse.</p></div></div></section>
