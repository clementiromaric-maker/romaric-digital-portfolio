  ...
  return (
    <>
      ...
      <main className="case-page case-page--editorial">
        ...
        <figure className="case-cover"><img className="case-transition-image" src="/assets/marzieh-homepage-v5114.webp" width="2048" height="1119" fetchPriority="high" decoding="async" alt="Marzieh Nail Atelier live-forside med navigation, bookinghandlinger og neglebillede" /><figcaption>Live produktionswebsite · danske og engelske ruter</figcaption></figure></div></section>
        ...
        <section className="case-section case-section--screens"><div className="wrap"><div className="case-section__heading case-section__heading--wide"><p className="mono">04 / Interface</p><h2>Skærmene følger de spørgsmål, kunderne stiller før booking.</h2></div><div className="case-gallery-editorial"><figure className="case-shot case-shot--large"><img src="/assets/marzieh-services-ui-snapshot.webp" width="760" height="520" loading="lazy" decoding="async" alt="Marzieh Nail Atelier service- og prisinterface" /><figcaption><span>Services og priser</span>Gør tilbuddet tydeligt før bookingbeslutningen.</figcaption></figure><figure className="case-shot"><img src="/assets/marzieh-work-ui-snapshot.webp" width="760" height="520" loading="lazy" decoding="async" alt="Marzieh Nail Atelier arbejdsgalleri" /><figcaption><span>Arbejde og tillid</span>Vis kvaliteten og stilen kunden kan forvente.</figcaption></figure><figure className="case-shot"><img src="/assets/marzieh-booking-ui-snapshot.webp" width="760" height="520" loading="lazy" decoding="async" alt="Marzieh Nail Atelier booking- og besøgsinterface" /><figcaption><span>Booking og besøg</span>Gør næste skridt og praktiske detaljer lette at finde.</figcaption></figure></div></div></section>
