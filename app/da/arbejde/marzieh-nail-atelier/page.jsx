  ...
  return (
    <>
      ...
      <main className="case-page case-page--editorial">
        ...
        <section className="case-section case-section--screens"><div className="wrap"><div className="case-section__heading case-section__heading--wide"><p className="mono">04 / Interface</p><h2>Skærmene følger de spørgsmål, kunderne stiller før booking.</h2></div><div className="case-gallery-editorial case-gallery-editorial--real"><figure className="case-shot case-shot--large"><img src="/assets/marzieh-live-mobile-composition-actual.webp" width="688" height="980" loading="lazy" decoding="async" alt="Reelt mobilskærmbillede af The Atelier Composition-siden" /><figcaption><span>Signaturservice</span>Reelt mobiludsnit af Atelier Composition-forløbet.</figcaption></figure><figure className="case-shot"><img src="/assets/marzieh-live-mobile-service-clean-actual.webp" width="688" height="670" loading="lazy" decoding="async" alt="Reelt beskåret mobilskærmbillede af Marzieh Nail Ateliers serviceforløb og Japanese Manicure-kort" /><figcaption><span>Services</span>Reelt mobiludsnit med serviceforløb og priskontekst uden browserramme.</figcaption></figure><figure className="case-shot"><img src="/assets/marzieh-live-mobile-guide-actual.webp" width="688" height="1430" loading="lazy" decoding="async" alt="Reelt mobilskærmbillede af en Marzieh Nail Atelier-guide" /><figcaption><span>Guideindhold</span>Reelt mobiludsnit af Gel Nails vs Shellac-guiden.</figcaption></figure></div></div></section>
