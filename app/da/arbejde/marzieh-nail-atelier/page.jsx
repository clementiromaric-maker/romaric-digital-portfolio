...
const evidence = [
  ...
  ['Mobil QA', 'Navigation, kort, skærmbilleder, trykflader, lange tekster og bookinghandlinger'],
  ['Tillidslag', '5.0 bedømmelse, 16 Google-anmeldelser, CVR, politikker og lokal besøgsinformation'],
  ['Overdragelse', 'Versionsstyret kildepakke, byggetest, udgivelsesnoter og tydelige næste skridt'],
];
