...
export default function MarziehCaseStudyDa() {
  ...
  return (
    <>
      ...
      <header className="bar case-bar"><div className="wrap bar__in"><a className="brand" href="/da/#work" aria-label="Tilbage til Romaric Clementis portfolio"><b>RC</b><span>Romaric Clementi · Case</span></a><nav className="case-nav" aria-label="Case-navigation"><a href="/da/#work">← Portfolio</a><span className="lang-switch" role="group" aria-label="Sprogvalg"><a href="/work/marzieh-nail-atelier/">EN</a><span aria-hidden="true">/</span><a aria-current="page" href="/da/arbejde/marzieh-nail-atelier/">DA</a></span><a className="btn case-live-cta" href={liveUrl} target="_blank" rel="noopener noreferrer"><span className="case-live-cta__desktop">Live site ↗</span><span className="case-live-cta__mobile">Live ↗</span></a></nav></div></header>

      <main className="case-page">
        <section className="case-hero"><div className="wrap"><nav className="case-breadcrumb" aria-label="Brødkrummer"><a href="/da/">Portfolio</a><span>/</span><a href="/da/#work">Udvalgt arbejde</a><span>/</span><strong>Marzieh Nail Atelier</strong></nav><div className="case-hero__grid"><div><p className="mono">Portfolio-case · Case 01 · Live lokal virksomhed</p><h1>Marzieh Nail Atelier: en tydeligere tosproget bookingrejse.</h1><p className="case-hero__lede">Denne side forklarer problemet, beslutningerne, implementeringsbeviserne og mit bidrag. Det live kundesite åbner separat.</p><div className="case-hero__actions"><a className="btn" href="#story">Læs casen ↓</a><a className="btn btn--ghost" href={liveUrl} target="_blank" rel="noopener noreferrer">Åbn live website ↗</a></div></div><div className="case-hero__stats" aria-label="Case-dokumentation"><div><b>5.0</b><span>Google-rating</span></div><div><b>16</b><span>Google-anmeldelser</span></div><div><b>DA / EN</b><span>Tosprogede sider</span></div><div><b>Live</b><span>Website i produktion</span></div></div></div><div className="case-context-card" aria-label="Casekontekst"><div><span className="mono">Det ser du her</span><b>En selvstændig portfolio-case</b><p>Ikke endnu en portfolio-forside: siden dokumenterer ét implementeret projekt og beslutningerne bag det.</p></div><dl><div><dt>Projektrelation</dt><dd>Reel case for nærtstående virksomhed</dd></div><div><dt>Status</dt><dd>Live produktionswebsite</dd></div><div><dt>Mit ansvar</dt><dd>Retning, struktur, review, QA, deployment og overdragelse</dd></div></dl></div><div className="case-browser case-browser--hero"><div className="browser__bar"><div className="browser__dots" aria-hidden="true"><i /><i /><i /></div><span className="browser__url">marziehnail-atelier.dk</span><span className="browser__live">● Live</span></div><div className="case-browser__canvas"><img className="case-transition-image" src="/assets/marzieh-homepage-ui-snapshot.webp" width="1600" height="1050" fetchPriority="high" decoding="async" alt="Marzieh Nail Atelier forside med navigation, servicekort og bookingrejse" /></div></div></div></section>

        <section id="story" className="case-chapter"><div className="wrap case-chapter__grid"><div className="case-chapter__title"><span className="case-number">01</span><p className="mono">Inputtet</p><h2>En stærk service med spredt kundeinformation.</h2></div><div className="case-copy"><p>Kunder skulle forstå forskelle mellem services, priser, tidsforbrug, nail-art-muligheder, politikker, placering og booking. Ejeren havde samtidig brug for kontrol over den officielle informationskilde.</p><p>Udfordringen var at skabe premium ro uden at skjule praktisk information eller gøre kunderejsen kompliceret.</p><aside className="case-ai-note"><span className="mono">Oplysning om AI-assisteret produktion</span><p>Claude, ChatGPT og andre AI-værktøjer understøttede research, udkast, kodehjælp, sammenligning og iteration. Jeg definerede brief og retning, traf de endelige struktur- og indholdsbeslutninger, gennemgik og testede implementeringen og havde ansvaret for deployment og overdragelse.</p></aside></div></div></section>
        ...
        <section className="case-outcome"><div className="wrap case-outcome__grid"><div><p className="mono">Hvad casen viser</p><h2>Det færdige website er synligt. Den dybere værdi er den operationelle klarhed under det.</h2></div><div><p>Jeg kan tage løst kundemateriale, definere kunde- og forretningsbeslutningerne, lede et AI-assisteret produktionsworkflow, teste implementeringen og efterlade en tydelig, gennemgåelig overdragelse.</p><div className="case-outcome__actions"><a className="btn" href={liveUrl} target="_blank" rel="noopener noreferrer">Åbn live website ↗</a><a className="btn btn--ghost" href="/da/#contact">Tal om en rolle eller opgave</a></div></div></div></section>
      </main>

      <footer><div className="wrap foot"><div className="mark"><b>RC</b><span>Uklart menneskeligt og forretningsmæssigt behov → klart digitalt system.</span></div><div className="fine">Portfolio-case · AI-assisteret produktion oplyst · Romaric Clementi</div></div></footer>
    </>
  );
}
