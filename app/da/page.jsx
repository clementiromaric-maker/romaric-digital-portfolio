...
const roleFitLanes = [
  ...
  },
  {
    ...
    text: 'Kunderejser, tillidssektioner, navigation, sidehierarki, CTA-logik og en tydeligere vej fra oplæg til implementering.',
  },
  {
    label: '03',
  ...
  {
    label: '04',
    title: 'Digital levering og QA',
    text: 'GitHub-baserede arbejdsgange, Jira-opfølgning, mobilcheck, links, udgivelsesnoter, accepttjek og praktisk overdragelse.',
  },
];
        ...
        <section className="hero" id="top" aria-labelledby="hero-title-da">
          <div className="wrap hero__grid">
            <div>
              ...
              <p className="hero-role reveal" style={{ transitionDelay: '.1s' }}>Digital produktion · Webindhold · QA</p>
              ...
              <p className="sub reveal" style={{ transitionDelay: '.3s' }}>
                Website-produktion, UX- og indholdsstruktur, CMS-implementering, responsiv QA og flersproget levering.
              </p>
            ...
            <aside className="spec reveal" style={{ transitionDelay: '.28s' }} aria-label="Portfolio hurtige fakta">
              ...
              <dl>
                ...
                <div className="row">
                  ...
                  <dd>Live tosproget virksomhedssite, reel bookingrejse, responsiv QA og ejeroverdragelse</dd>
                </div>
              </dl>
            </aside>
          </div>
