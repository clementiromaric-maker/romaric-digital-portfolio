      ...
      <main className={`portfolio-view is-${viewMode}`}>
        ...
        <section id="capabilities" className="deep-dive-section">
          <div className="wrap">
            ...
            <div className="exposure reveal"><p className="mono lab">Værktøjer i praksis</p><div className="chips" aria-label="Arbejdseksponering">{['HTML / CSS','Next.js / statisk levering','Basic JavaScript','Cloudflare / GitHub-levering','Sanity CMS / preview-workflows','Struktureret indhold / genbrugelige sektioner','Valideringsregler','Jira issue-/handlingsopfølgning','Webflow / Shopify-kendskab','SEO / Search Console / LocalBusiness JSON-LD','Formularer / flersprogede flows','Mobil og responsiv QA','Dokumentation / overdragelse'].map((item) => <b key={item}>{item}</b>)}</div><p className="caveat">Bygget som et custom statisk Next.js/Cloudflare-site. Mit stærkeste bidrag er produktion, struktureret indhold, QA og overdragelse. Sanity CMS og Jira afspejler udvalgte projektworkflows, mens Webflow og Shopify fortsat er praktisk kendskab. Supplerende systemgrundlag: formel SQL 2016 Database Administration-træning med SQL Server/T-SQL, relationelt databasedesign og Azure SQL. Det er kursusbaseret erfaring, ikke nyere professionel Azure-anvendelse.</p></div>
          </div>
        </section>
